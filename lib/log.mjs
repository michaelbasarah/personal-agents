/**
 * Structured logging + crash handling.
 *
 * One logger, two shapes:
 *   - DEV (default): readable single lines, e.g. `· spend_logged | amount=25000 cat=Food & Drink`.
 ...
 * an optional `alert` callback — the seam for owner/ops alerting once a channel exists.
 */
